...
public class FieldMasterRepositoryTest {
    public static class フィールド定義が存在しない場合 {
        ...
        public void findAll実行時に空のリストが返されること() throws Exception {
            try (SqlSession session = factory.openSession()) {
                ...
                final List<FieldMaster> recordset = fieldMasterRepository.findAll();
        ...
        public void create実行時にレコードを登録できてtrueが返されること() throws Exception {
            final String[] params1 = { "1", "1", "field1", "フィールド1", "1つ目のフィールド" };
            final FieldMaster expect1 = helper.createFieldMaster(params1);

            final String[] params2 = { "1", "2", "field2", "フィールド2", "2つ目のフィールド" };
            ...
            try (SqlSession session = factory.openSession()) {
                ...
                final List<FieldMaster> actualList = fieldMasterRepository.findAll();
                assertThat(actualList.size(), is(expectList.size()));

                final FieldMaster actual1 = fieldMasterRepository.findByTableIdAndNo(expect1.getTableId(),
                        expect1.getNo());
                ...
                assertThat(actual1.getPhysicalName(), is(expect1.getPhysicalName()));
                assertThat(actual1.getLogicalName(), is(expect1.getLogicalName()));
                assertThat(actual1.getDescription(), is(expect1.getDescription()));
                assertThat(actual1.getDeleteFlag(), is(expect1.getDeleteFlag()));

                final FieldMaster actual2 = fieldMasterRepository.findByTableIdAndNo(expect2.getTableId(),
                        expect2.getNo());
                ...
                assertThat(actual2.getPhysicalName(), is(expect2.getPhysicalName()));
                assertThat(actual2.getLogicalName(), is(expect2.getLogicalName()));
                assertThat(actual2.getDescription(), is(expect2.getDescription()));
    ...
    public static class フィールド定義が存在する場合 {
        ...
        public static void setUpBeforeClass() throws Exception {
            ...
            final TableMaster table2 = helper.createTableMaster(params2);
        ...
        public void setUp() throws Exception {
            ...
            // テーブル1
            final String[] params1 = { "1", "1", "field1", "フィールド1", "table1.field1" };
            final FieldMaster field1 = helper.createFieldMaster(params1);
            fieldList.add(field1);

            final String[] params2 = { "1", "2", "field2", "フィールド2", "table1.field2", "1" };
            final FieldMaster field2 = helper.createFieldMaster(params2);
            fieldList.add(field2);

            // テーブル2
            final String[] params3 = { "2", "1", "field1", "フィールド1", "table2.field1" };
            final FieldMaster field3 = helper.createFieldMaster(params3);
            fieldList.add(field3);

            final String[] params4 = { "2", "2", "field2", "フィールド2", "table2.field2", "1" };
        ...
        public void create実行時にレコードを登録できてtrueが返されること() throws Exception {
            ...
            final String[] params1 = { "1", "3", "field3", "フィールド3", "table1.field3" };
            final FieldMaster expect1 = helper.createFieldMaster(params1);
            expectList.add(expect1);

            final String[] params2 = { "1", "4", "field4", "フィールド4", "table1.field4" };
            final FieldMaster expect2 = helper.createFieldMaster(params2);
            expectList.add(expect2);
            ...
            try (SqlSession session = factory.openSession()) {
                ...
                final List<FieldMaster> actualList1 = fieldMasterRepository.findAll();
                assertThat(actualList1.size(), is(6));

                final List<FieldMaster> actualList2 = fieldMasterRepository.findByTableId(1);
                ...
                final FieldMaster actual2 = fieldMasterRepository
                        ...
                        .findByTableIdAndNo(expect2.getTableId(), expect2.getNo());
        ...
        public void update実行時にレコードを更新できてtrueが返されること() throws Exception {
            try (SqlSession session = factory.openSession()) {
                ...
                final FieldMaster expect1 = fieldMasterRepository.findByTableIdAndNo(2, 2);
                expect1.setPhysicalName("update1");
                expect1.setLogicalName("更新1");
                expect1.setDescription("table2.update1");
                expectList.add(expect1);

                final FieldMaster expect2 = fieldMasterRepository.findByTableIdAndNo(2, 1);
                expect2.setPhysicalName("update2");
                expect2.setLogicalName("更新2");
                expect2.setDescription("table2.update2");
                expectList.add(expect2);

                final boolean result = fieldMasterRepository.update(expectList);
                assertThat(result, is(true));
                session.commit();

                final List<FieldMaster> actualList = fieldMasterRepository.findByTableId(2);
        ...
        public void deleteByDeleteFlag実行時にdeleteFlagが1であるレコードを削除できてtrueが返されること() throws Exception {
            try (SqlSession session = factory.openSession()) {
                fieldMasterRepository = session.getMapper(FieldMasterRepository.class);
                final boolean result = fieldMasterRepository.deleteByDeleteFlag();
                assertThat(result, is(true));
                session.commit();
