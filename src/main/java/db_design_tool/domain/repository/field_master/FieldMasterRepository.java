...
public interface FieldMasterRepository {
   ...
   * @return recordset 条件に合致する {@link FieldMaster} の {@link List}
   * @throws Exception {@link java.lang.Exception}
   */
   ...
   * @return record 条件に合致する {@link FieldMaster} の {@link List}
   * @throws Exception {@link java.lang.Exception}
   */
   ...
   * @throws Exception {@link java.lang.Exception}
   */
  FieldMaster findByFieldId(@Param("fieldId") int fieldId) throws Exception;
